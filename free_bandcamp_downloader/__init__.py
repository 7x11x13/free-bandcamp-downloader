...
if 'XDG_CONFIG_HOME' in os.environ:
    ...
    config_dir = os.path.join(os.path.expanduser('~'), '.config', 'free-bandcamp-downloader')

if 'XDG_DATA_HOME' in os.environ:
    data_dir = os.path.join(os.environ['XDG_DATA_HOME'], 'free-bandcamp-downloader')
else:
    data_dir = os.path.join(os.path.expanduser('~'), '.local', 'share', 'free-bandcamp-downloader')
